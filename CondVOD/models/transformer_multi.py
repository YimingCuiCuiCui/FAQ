...
class Transformer(nn.Module):
    ...
    def __init__(self, d_model=512, nhead=8, num_queries=300, num_encoder_layers=6,
                 ...
                 activation="relu", normalize_before=False, enc_n_points=4,
                 return_intermediate_dec=False, n_temporal_decoder_layers=1,
        ...
        temp_decoder_layer = DeformableTransformerDecoderLayer(d_model, dim_feedforward,
                                                          dropout, activation,
                                                          num_feature_levels, nhead, dec_n_points)
        self.temporal_decoder = TemporalDeformableTransformerDecoder(temp_decoder_layer, n_temporal_decoder_layers, False)
    ...
    def forward(self, src, mask, query_embed, pos_embed, class_embed=None):
        ...
        if self.fixed_pretrained_model:
            ...
            hs = hs.detach()
            inter_references = references.detach()
        ...
        last_hs = hs[-1]
        last_reference_out = inter_references_out
        ...
        final_hs, final_references_out = self.temporal_decoder(cur_hs, cur_reference_out, cur_memory,
                                                               ...
                                                               None, None)
        return hs[:, 0:1, :, :], references[0:1], final_hs, final_references_out
